...
class CartPage(Base):
    ...
    # LOCATORS ___________________________________________________________________________
    ...
    # GETTERS ___________________________________________________________________________

    def get_order_button(self):
        return self.wait.until(ec.element_to_be_clickable((By.XPATH, self.order_button_xpath)))


    # ACTIONS ___________________________________________________________________________
